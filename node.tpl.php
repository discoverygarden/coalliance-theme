<?php
// $Id: node.tpl.php,v 1.2.2.3 2008/06/19 08:13:27 hswong3i Exp $
?>
<div class="node<?php print $sticky ? ' sticky' : '' ?><?php print $status ? '' : ' node-unpublished' ?>">
  ...
  <?php /*  <?php if (node_access('update', $node)): ?><a href="<?php print url('node/'. $node->nid .'/edit') ?>" class="editlink" title="<?php print t('Edit') ?>"> </a><?php endif; ?>
