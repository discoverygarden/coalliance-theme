 ...
 *   A form array.
 */
function digitalunc_settings($saved_settings) {

  // Get the default values from the .info file.
  $defaults = zen_theme_get_default_settings('pdacc');
  ...
  $form['digitalunc_example'] = array(
    '#type'          => 'checkbox',
    '#title'         => t('Use this sample setting'),
    '#default_value' => $settings['digitalunc_example'],
